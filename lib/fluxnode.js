...
FluxNodeController.prototype.doslist = function (req, res) {
  this.node.services.bitcoind.doslist(function (err, response) {
    if (err) {
      res.jsonp(err);
      return;
    }
...
FluxNodeController.prototype.startlist = function (req, res) {
  this.node.services.bitcoind.startlist(function (err, response) {
    if (err) {
      res.jsonp(err);
      return;
    }
