...
AddressController.prototype.fluxnodemultiutxo = function(req, res) {
  ...
  this.node.getAddressUnspentOutputs(req.addrs, {}, function(err, utxos) {
    ...
    async.map(utxos, self.transformUtxo.bind(self), function(err, results) {
      ...
      const forkHeightAllowCumulus = networkName === 'testnet' ? 420 : 1076532;
      const forkHeightDisallowCumulus = networkName === 'testnet' ? 420 : 1086612;
      const forkHeightAllowNimbus = networkName === 'testnet' ? 420 : 1081572;
      const forkHeightDisallowNimbus = networkName === 'testnet' ? 420 : 1092372;
      const forkHeightAllowStratus = networkName === 'testnet' ? 420 : 1087332;
      const forkHeightDisallowStratus = networkName === 'testnet' ? 420 : 1097412;
