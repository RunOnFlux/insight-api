...
StatisticsController.prototype.totalSupplyAllChains = function(req, res) {

    var totalSupply = this.statisticService.getTotalSupplyAllChains().toString();
...
StatisticsController.prototype.circulatingSupply = function(req, res) {
    ...
    var circulatingSupplyBN = this.statisticService.getCirculatingSupplyAllChains();
    var circulatingSupply = circulatingSupplyBN.toString();
...
StatisticsController.prototype.circulatingSupplyAllChains = function(req, res) {
...
StatisticsController.prototype.mainChainCirculatingLocked = function(req, res) {

    var circulatingSupplyBN = this.statisticService.getCirculatingSupply();
    var circulatingSupply = circulatingSupplyBN.toString();
...
StatisticsController.prototype.activeAddresses = function(req, res) {

    var self = this,
        days = self.getTimeSpan(req);

    return self.statisticService.getActiveAddresses(days, function (err, diffs) {
